      ...
      <div class="boxProduct_conteiner">
        ...
        <div class="boxProduct_gallery">
          ...
          <div class="boxProduct_gallery_miniature">
            <button><img src="https://assets.onecompiler.app/42wu6ajnx/4392x5mts/arrow_up.png" alt="ArrowUp" /></button>
            ${product.images.map(image => `
              <div class="boxProduct_gallery_miniatureConteiner">
                <img src="${image}" alt="Miniatura de ${product.name}" />
              </div>
            `).join('')}
            <button><img src="https://assets.onecompiler.app/42wu6ajnx/4392x5mts/arrow_down.png" alt="ArrowDown" /></button>
          </div>
        ...
        <div class="boxProduct_description">
          ...
          <div class="boxProduct_descriptionPrice">
            <div class="boxProduct_offerPrice">
              ...
              <h1>R$ ${formatPrice((product.price - ((product.discountOffer * product.price)/100)) - ((product.discount * (product.price - ((product.discountOffer * product.price)/100)))/100))}</h1>
              <p>à <strong>vista</strong> com <strong>${product.discount}% OFF</strong>no boleto ou pix</p>
            </div>
            <h3><p>ou </p> R$ ${formatPrice(product.price - ((product.discountOffer * product.price)/100))}</h3>
            <p>até <strong> ${product.installments}x </strong> de <strong> R$ ${formatPrice(((product.price) - (((product.discountOffer) * (product.price))/100))/product.installments)} </strong> sem juros</p>
          </div>
