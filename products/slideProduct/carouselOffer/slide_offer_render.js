  ...
  return `
    <div class="boxProduct" id="boxProductDesk">
      ...
      <div class="boxProduct_descriptionTitle">
        <a href="${product.link}" target="_black"><h1>${product.name}</h1></a>
      </div>
        ...
        <div class="boxProduct_description">
          ...
          <div class="boxProduct_descriptionPrice">
            <div class="boxProduct_offerPrice">
              <h2> de <strong>R$ ${formatPrice(product.price)}</strong> por: </h2>
              <h1>R$ ${formatPrice((product.price - ((product.discountOffer * product.price)/100)) - ((product.discount * (product.price - ((product.discountOffer * product.price)/100)))/100))} <strong>à vista</strong></h1>
            </div>
            <div class="boxProduct_installmentsPrice">
              <h3><p>ou </p> R$ ${formatPrice(product.price - ((product.discountOffer * product.price)/100))}</h3>
              <p>até <strong> ${product.installments}x </strong> de <strong> R$ ${formatPrice(((product.price) - (((product.discountOffer) * (product.price))/100))/product.installments)} </strong></p>
            </div>
          </div>
      ...
      <div class="boxStampOffer" >
        <span>${product.discount}% <strong>OFF</strong></span>
